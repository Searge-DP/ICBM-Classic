...
/** Written By Herobrine11892 (with additional vanilla minecraft code from PressurePlate) **/

public class GlassPressurePlate extends BlockPressurePlate{
	
	private BlockPressurePlate.Sensitivity field_150069_a;
    private static final String __OBFID = "CL_00000289";

    protected GlassPressurePlate(String p_i45418_1_, Material p_i45418_2_, BlockPressurePlate.Sensitivity p_i45418_3_)
    {
